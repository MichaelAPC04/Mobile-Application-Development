...
public class NewEventCategory extends AppCompatActivity {
    ...
    String CategoryID, CategoryName, EventCount, EventLocation;
    Boolean IsActive;
    private EMAViewModel emaViewModel;
    MyRecyclerAdapterEventCategory eventCategoryAdapater;
    ...
    public void onClickCategoryID(View view){
        ...
        try {
            ...
            else if (CategoryName.matches("[a-zA-Z0-9 ]*") && !Objects.equals(CategoryName, "") && !Objects.equals(EventLocation, "")) {

                EventCategory eventCategory = new EventCategory(CategoryID, CategoryName, intEventCount, IsActive, EventLocation);
...
//                }
                ...
                //Save to db
                emaViewModel.insertEventCategory(eventCategory);
...
//                editor.apply();
                ...
                String message = "Invalid Event Location, it cannot be empty.";
                Toast.makeText(this, message, Toast.LENGTH_SHORT).show();
            }
