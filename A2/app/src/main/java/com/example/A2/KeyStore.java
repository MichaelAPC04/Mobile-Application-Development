...
public class KeyStore {
    ...
    public static final String SP4_FILENAME = "event-data.dat";
    public static final String SP5_FILENAME = "event-data-list";
    public static final String SP6_FILENAME = "category-data.dat";
    public static final String SP7_FILENAME = "category-data-list";
